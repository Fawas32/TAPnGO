...
public class XMLParser {
    ...
    public List<StationData> parse(InputStream inputStream) throws XmlPullParserException, IOException {
        try {
    ...
    private List<StationData> readArrayOfObjStationData(XmlPullParser parser) throws XmlPullParserException, IOException {
    ...
    private StationData readStationData(XmlPullParser parser) throws XmlPullParserException, IOException {
